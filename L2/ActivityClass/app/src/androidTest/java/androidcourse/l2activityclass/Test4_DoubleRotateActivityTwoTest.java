...
import androidcourse.l2activityclass.ActivityOne;
...
public class Test4_DoubleRotateActivityTwoTest extends ActivityInstrumentationTestCase2<ActivityOne> {
	...
	public void testRun() {
		...
		assertTrue("DoubleRotateActivityTwoTest failed:" +
				   ...
				   solo.waitForActivity(androidcourse.l2activityclass.ActivityOne.class, timeout));
		...
		assertTrue("DoubleRotateActivityTwoTest failed:" +
				   ...
				   solo.waitForActivity(androidcourse.l2activityclass.ActivityTwo.class, timeout));
