...
//                Intent intent = new Intent();
//                intent.putExtra(ToDoItem.TITLE,titleString);
//                intent.putExtra(ToDoItem.STATUS,status);
//                intent.putExtra(ToDoItem.PRIORITY,priority);
//                intent.putExtra(ToDoItem.DATE, fullDate);
//
//                ToDoItem res = new ToDoItem(intent);
